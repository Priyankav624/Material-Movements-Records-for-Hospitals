...
router.post("/request", authMiddleware, requestMaterial);
router.get("/", authMiddleware, roleMiddleware(["Admin", "Store Manager"]), getRequests);
router.put("/:id", authMiddleware, roleMiddleware(["Admin", "Store Manager"]), updateRequestStatus);
router.get("/my-requests", authMiddleware, getMyRequests);
router.get("/track-issued", authMiddleware, roleMiddleware(["Admin", "Store Manager"]), trackIssuedItems);
